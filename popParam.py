...
class ModParam:
    def __init__(self):
        ...
        self.dil_th = 0.55
        self.dil_amount = 0.12
        self.Dil_sp = 0.5
        self.Avg_temp = True
        self.Lag = 3 # hours
        # TODO: Adapt min/max fluorescense values of the respective reactors
        # self.e1_ofs = [0.0384, 0.141, 0.112, 0.119, 0.104, 0.13, 0.093, 0.108]
        self.e1_ofs = np.array([0.06670286988458429, 0.09954091472779605, 0.01339878054716663, 0.09732706551691282, 0.08975873832801415, 0.1128096218942311, 0.061012361789911165, 0.04765733175961176]).T # [0.037, 0.064, 0.057, 0.058, 0.036, 0.068, 0.064, 0.061]
        self.max_fl = []
        self.minv = 0.059
        self.maxv = 0.290
        self.od_fac = np.array([1.0])
